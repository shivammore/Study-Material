;With String Block Transfer Overlapping
;***********************************************************
...
;***********************Output*************************
;student@IOE-HWLAB:~/Micro/Lab2$ nasm -f elf64 wsov.asm -o obj.o
...
;Block contents before Overlap
;Source block contents::01 02 03 04 05 
;Enter position to overlap::08
;Block contents after Overlap
;Source block contents::01 02 03 04 05 00 00 00 01 02 03 04 05 
;student@IOE-HWLAB:~/Micro/Lab2$ ./obj
;Block contents before Overlap
;Source block contents::01 02 03 04 05 
